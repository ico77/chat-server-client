...
public class ChatClientView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPortTextField.addCaretListener(new javax.swing.event.CaretListener() {
            public void caretUpdate(javax.swing.event.CaretEvent evt) {
                jPortTextFieldCaretUpdate(evt);
            }
        });
        jPortTextField.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseExited(java.awt.event.MouseEvent evt) {
                jPortTextFieldMouseExited(evt);
            }
        });
        jPortTextField.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                jPortTextFieldFocusLost(evt);
            }
        });
    ...
    /**
     * Manages the components in the start dialog when the port text field loses focus.
     *
     * @param evt the focus event that triggered the action
     */
    private void jPortTextFieldFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jPortTextFieldFocusLost
        manageJPortTextField();
    }//GEN-LAST:event_jPortTextFieldFocusLost

    /**
     * Manages the components in the start dialog when the mouse exits the port text field.
     *
     * @param evt the focus event that triggered the action
     */
    private void jPortTextFieldMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPortTextFieldMouseExited
        manageJPortTextField();
    }//GEN-LAST:event_jPortTextFieldMouseExited

    /**
     * Manages the components in the start dialog when the port text field caret is updated.
     *
     * @param evt the caret event that triggered the action
     */
    private void jPortTextFieldCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jPortTextFieldCaretUpdate
        manageJPortTextField();
    }//GEN-LAST:event_jPortTextFieldCaretUpdate
    ...
    /**
     * Gets the message from the text input control. If the method is not invoked on the EDT, schedule a Runnable on the EDT that will read the message and wait for the result
     */
    ...
    /**
     * Gets the Server URL string from the text input control. If the method is not invoked on the EDT, schedule a Runnable on the EDT that will read the value and wait for the result
     */
    ...
    /**
     * Gets the server port number from the text input control. If the method is not invoked on the EDT, schedule a Runnable on the EDT that will read the value and wait for the result
     */
    public int getPort() {
        if (EventQueue.isDispatchThread()) {
    ...
    /**
     * Appends the message to the document in the text pane.
     * If the method is not invoked on the EDT, schedule a Runnable on the EDT that will read the value and wait for the result
     */
